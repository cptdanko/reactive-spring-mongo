# Spring reactive API using MongoDB

A simple API with the aim to show how to build a Spring reactive API that CRUDs data to a MongoDB database.

In addition to this repository, you can checkout some of my other work e.g.
